...
// 공통규칙
// 1. 자바는 50여가지의 예약어(키워드)가 있고 해당 예약어에는
//    자바가 내부적으로 지정한 프로그래밍적 기능이 있기 때문에
//    해당 예약어로는 이름을 지어줄 수 없다.
//    이클립스에선 예약어를 자주색으로 표시해준다.
//    예시: public, class, package ...
//    만약 어떠한 이름을 지어주는데 해당 이름이 자주색으로 출력이 되면
//    변형을 해주거나 다른 단어로 변경하면 된다.
...
// 낙타등 표기법이란
// 여러 단어로 이루어진 이름의 경우 두번째 단어부터는 첫글자를 대문자로 적어서 단어의 구별을 용이하게 하는 이름 짓기 규칙이다.
// 예시: firstNumber memberController selectAll() ...
// 뱀 표기법이란
// 모든 글자를 대문자로 적어주고 단어의 사이에는 _를 끼어넣는 방법이다.
