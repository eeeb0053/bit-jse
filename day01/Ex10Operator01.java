package day01;
// 연산자
// 연산자란 수학적 기호에 프로그래밍적 기능이 정의되어 있어서
// 우리가 특정 기호를 쓰면 내부정으로 해당 기능이 실행되는 것을 뜻한다.
// 연산자에는
...
public class Ex10Operator01 {
    public static void main(String[] args) {
        ...
        // myNumber1 / myNumber2는 int / int 이기 때문에
        // 몫만 온전하게 나온다.
        // 즉 0이란 결과값을 실수로 바꾸면?
        // 0.0이 되기 때문이다.
        
        // String이란?
        // 여러개의 문자를 모아둔 문자열을 관리하는 클래스이다.
        // 우리가 스트링 변수를 만들게 되면
        // 여러개의 문자를 다루겠다라는 의미가 된다.
        // ""로 둘러싸인 문자들은 String으로 인식된다.
        String string = new String();
        // 그렇다면 여러개의 문자에 + 연산자를 실행하면 어떤 결과가 나올까?
        // 만약 스트링 + 스트링의 경우, 2개의 문자열을 이어붙이겠다는 의미가 된다.
        string = "abc";
        ...
        // 이때에는 현재 변수의 값을 1씩 증가시키거나 감소시키라는 의미가 된다.
