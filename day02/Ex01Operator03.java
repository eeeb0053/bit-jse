...
public class Ex01Operator03 {
    public static void main(String[] args) {
        ...
        System.out.println("number1 <= number2: "+(number1 <= number2));
        // number1에 저장된 값이 number2에 저장된 값보다 같습니까?
        System.out.println("number1 == number2: "+(number1 == number2));
        // number1에 저장된 값이 number2에 저장된 값보다 다릅니까?
        System.out.println("number1 != number2: "+(number1 != number2));
        
        // 하지만 비교연산자의 경우, 클래스형 변수에 대한 비교는 부정확한 값을 연산하게 된다.
        
        System.out.println("===클래스형 변수의 비교===");
        ...
        // 그 때문에 주소값이 달라지게 된 것이다.
        // 하지만 비교 연산자는 참조형 변수의 실제 어떤 값이 있는지를 비교하는 것이 아니라
        // 주소값을 비교하기 때문에
        // 부정확한 결과값이 나오게 된다.
        // 우리가 클래스형 변수들을 비교할 때에는 주소값 비교보다는 
        // 그 안에 어떤 값이 들어가 있는지를 비교하고 싶은게 더 정확하기 때뭉네
        // 클래스형 변수를 비교할 때에는 비교 연산자를 사용하면 안된다.
        
        // 그렇다면 클래스형 변수를 비교할 때에는 무엇을 사용해야 하는가?
        // 바로 메소드를 이용해서 비교를 해야한다.
        // 두 개의 클래스형 변수가 같은지 비교할 때에는
        // equals 메소드를 사용하면 된다.
        System.out.println("===equals 메소드를 통한 비교===");
        System.out.println("String1.equals(string1): "+string1.equals(string2));
