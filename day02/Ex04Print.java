...
// println: print a line의 줄임말. ()안의 내용을 출력하고, 다음 출력위치는 다음줄 첫번째칸이 된다.
// printf: print in format의 줄임말. ()안의 내용을 '형식에' 맞추어 출력하고, 다음 출력위치는 바로 오른쪽 칸이 된다.
public class Ex04Print {
    public static void main(String[] args) {
        // 1. print()
        System.out.print("1.abc");
        System.out.print("2.EDF");
