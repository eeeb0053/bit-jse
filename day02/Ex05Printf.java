package day02;
// printf
// printf는 출력할 내용에 % 문자를 사용하여
// 우리가 원하는 내용을 특정 형식을 출력 가능하다.
...
public class Ex05Printf {
    public static void main(String[] args) {
        ...
        // D. 10진법 정수를 오른쪽 정렬 5자리로 출력하고 왼쪽 빈자리는 0으로 채워라
        ...
        //    16진법은 각 자리가 0~15까지 16개의 숫자로 이루어져있고 
        //    각 자리가 16의 제곱으로 이루어진 숫자체계이다.
        //    10~15는 A~F로 표시한다.
        ...
        // G. 16진법 정수를 오른쪽 정렬 5자리로 표시하고 왼쪽 빈자리는 0으로 채운 후, 알파벳이 있으면 대문자로 표시해라
        ...
        // B. 문자열을 표시하되 소문자가 있으면 대문자로 바꾸어 출력해라
        System.out.printf("B. %S\n", string1);
     
        // prinf의 주의점
        // 1. 우리가 자릿수를 지정할 경우, 추력할 내용이 더 길면 자리수 지정은 무시된다. 
        System.out.printf("%3d\n", 1234567);
        // 2. 만약 잘못된 %문자를 쓰면 에러가 난다.
        //    예시: System.out.printf("%z\n", 123456);
        // 3. %와 맞지 않는 형식의 데이터가 넘어오면 에러가 난다.
        //    예시: System.out.printf("%d\n", 123.45);
        // 4. 만약 %문자가 나온 횟수보다 뒤의 값들이 더 많은 경우 에러가 나진 않지만
        //    반대로 %문자가 더 많이 나오면 에러가 난다.
        System.out.printf("%d %f %s\n", 1, 2.34, "abc", 4, 5.67);
        //    예시: System.out.printf("%d %d %d %d\n", 1, 2, 3);
