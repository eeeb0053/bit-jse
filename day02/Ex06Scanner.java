...
public class Ex06Scanner {
    public static void main(String[] args) {
        ...
        //    왜냐하면 우리가 키보드로 입력한 값이 버퍼메모리에 가는데
        //    우리가 입력이 끝났다는 것을 알려주기 위해서 엔터를 치면,
        //    nextInt(), nextDouble()은 엔터를 제외한 숫자값만 버퍼메모리에서 읽어서 없앤다
        //    즉, nextInt()를 실행해서 123\n라고 입력하면
        //    nextInt()가 123만 가져가고 \n은 버퍼메모리에 남겨둔다.
        //    하지만 nextLine()의 경우, 모든 문자를 다 가져올 수 있는데
        //    버퍼메모리에 남아있던 \n을 보고 "사용자가 입력을 끝냈구나" 라고 착각하게 된다.
        //    이것이 scanner의 nextLine() 버그이다.
        
        //    해당 버그를 해결하기 위해서는
        //    nextInt, nextDouble을 사용하고 nextLine을 사용하기 전에
        //    nextLine을 한번 더 실행해주면 된다.
        ...
        // close()라는 메소드를 가장 마지막에 호출해서
        // 버퍼메모리를 종료시켜 주는 것이 좋다.
        scanner.close();
    }
}
