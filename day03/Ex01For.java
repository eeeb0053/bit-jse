...
public class Ex01For {
    public static void main(String[] args) {
        ...
        // 2. i = 0 초기화
        // 3. i < 4 조건 확인
        // 4. System.out.println("i의 현재값: "+i) 코드 실행
        // 5. i++ 값 변화
        // 6. 이후론 3->4->5 반복
        ...
        // i -> j -> k ... 순으로 들어간다.
        // 또한 컨트롤 변수의 초기화나 조선식에 다른 변수가 ㅡㄷㄹ어갈 수도 있다.
        ...
        // 또한, 흔히 하는 실수 중 for() 뒤에 ;을 붙이는데 의미가 달라지게 된다.
        for(int i = 0; i < 4; i++);{
        ...
        // 스코프가 해당 for문이다.
        for(int i = 0; i < 4; i++) {
            System.out.println(i); // 여기는 scope라 문제 없음
        }
        // System.out.println(i); // scope를 벗어났으므로 에러

        // 컨트롤 변수를 밖으로 빼서
        // 선언과 초기화를 해줄 때에는 다음과 같은 형태를 가지게 된다.
        int i = 0;
        for(; i < 4; i++) {
            System.out.println(i);
        }
        // for 반복문은 ()안에 ;이 2번 나와야 한다.
        // 그러므로 선언과 초기화를 밖으로 뺄 때에는 ;조건식;변화식 의 형식으로 적어야 한다.
