...
public class Ex13GradeBook02 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // i번째 학생 국어점수
            scoreArray[i][0] = ScannerUtil.nextInt(scanner, (i+1)+"번 학생의 국어 점수: ", 1, 100);
            // i번째 학생 영어점수
            scoreArray[i][1] = ScannerUtil.nextInt(scanner, (i+1)+"번 학생의 영어 점수: ", 1, 100);
            // i번째 학생 수학점수
            scoreArray[i][2] = ScannerUtil.nextInt(scanner, (i+1)+"번 학생의 수학 점수: ", 1, 100);
        }
