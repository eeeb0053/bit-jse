...
public class BoardViewer04 {
    ...
    public void showMenu() {
        while(true) {
            ...
            String message = "1. 새글 작성 2. 글 목록 3. 종료";
    ...
    private void printAll() {
        ...
        // 향상된 for문, forEach 구조
        // 배열, 어레이리스트 등의 집합의 요소를 하나씩 호출해야하는 경우
        // 굳이 정식적인 if문을 적어주지 않고
        // "하나씩 뽑아서 객체a라고 부를게" 라고 해줄 수 있다.
        // 이것을 forEach 구조 혹은 향상된 for문이라고 한다.
        // 사용방법은
        // for(데이터타입 변수이름 : 리스트)
    ...
    private void printOne(int index) {
        ...
        System.out.println("수정날자: "+sdf.format(b.getUpdatedDate().getTime()));
        System.out.println("------------------------------");
