...
public class Ex01ArrayList {
    public static void main(String[] args) {
        // ArrayList는 처음 선언할 때
        // 무엇의 모음인지를 지정해야 한다.
        // 지정할 때에는 <> 안에 무슨 클래스의 모음인지를 지정해야하고
        // <> 안에는 클래스만 들어갈 수 있다!
        ...
        // 여기서부터는 요소의 클래스에 equals() 메소드가 정확하게 구현이 되어야
        // 정상적으로 실행되는 메소드들이다.

        Member m77 = new Member(7, "userName7", "password7", "nickName7");
        
        // 1. 해당 리스트의 특정 객체가 존재하는지 알고싶다면
        //    contains() 메소드
        //    단, 동일한 객체가 아니더라도 equals()가 true가 나오는 객체가 존재한다면
        //    contains()도 true가 나온다.
        ...
        //    indexOf() 메소드
        //    해당 객체가 리스트에 존재하지 않으면 -1이 리턴
        //    또한 동일한 객체가 아니더라도 equals()가 true가 나오는 객체가 존재한다면
        //    그 객체의 index가 리턴된다.
        ...
        // 3. 해당 리스트에서 특정 객체가 가장 마지막에 나오는 index가 궁금하다면
        //    lastIndexOf() 메소드
        memberList.add(m1);
        ...
        //    index가 아닌 해당 객체 
        //    혹은 그 객체와 equals() true가 나오는 객체를 사용하여 제거 가능
        //    remove()
